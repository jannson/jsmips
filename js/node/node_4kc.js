LOG_LEVEL = 2 // ./node/node_log.js:0
 // ./node/node_log.js:1
function terminal(m) { // ./node/node_log.js:2
    //console.log(m); // ./node/node_log.js:3
    process.stdout.write(m); // ./node/node_log.js:4
} // ./node/node_log.js:5
 // ./node/node_log.js:6
function DEBUG (m) { // ./node/node_log.js:7
    if(LOG_LEVEL >= 3){ // ./node/node_log.js:8
        console.log("DEBUG: " + m) // ./node/node_log.js:9
    } // ./node/node_log.js:10
} // ./node/node_log.js:11
 // ./node/node_log.js:12
function INFO(m) { // ./node/node_log.js:13
    if(LOG_LEVEL >= 2){ // ./node/node_log.js:14
        console.log("INFO: " + m) // ./node/node_log.js:15
    } // ./node/node_log.js:16
} // ./node/node_log.js:17
 // ./node/node_log.js:18
function WARN(m) { // ./node/node_log.js:19
    if(LOG_LEVEL >= 1){ // ./node/node_log.js:20
        console.log("WARN: " + m) // ./node/node_log.js:21
    } // ./node/node_log.js:22
} // ./node/node_log.js:23
 // ./node/node_log.js:24
function ERROR(m) { // ./node/node_log.js:25
    if(LOG_LEVEL >= 0){ // ./node/node_log.js:26
        console.log("ERROR: " + m) // ./node/node_log.js:27
    } // ./node/node_log.js:28
} // ./node/node_log.js:29
...
function null_serial () { // ./common/null_serial.js:3
 ...
 // ./common/null_serial.js:9
    } // ./common/null_serial.js:10
} // ./common/null_serial.js:11
...
function Emulator() { // ./common/Emu.js:4
 ...
 // ./node/node_serial.js:0
connectedSerialSockets = {}; // ./node/node_serial.js:1
 // ./node/node_serial.js:2
function registerSerialSocket( s ) { // ./node/node_serial.js:3
    connectedSerialSockets[s] = s; // ./node/node_serial.js:4
} // ./node/node_serial.js:5
 // ./node/node_serial.js:6
 // ./node/node_serial.js:7
function removeSerialSocket( s ) { // ./node/node_serial.js:8
    if(s in connectedSerialSockets){ // ./node/node_serial.js:9
        delete connectedSerialSockets[s]; // ./node/node_serial.js:10
    } // ./node/node_serial.js:11
} // ./node/node_serial.js:12
 // ./node/node_serial.js:13
function node_serial () { // ./node/node_serial.js:14
 // ./node/node_serial.js:15
    this.writeToConsole = function (data) { // ./node/node_serial.js:16
 // ./node/node_serial.js:17
        for(s in connectedSerialSockets){ // ./node/node_serial.js:18
            connectedSerialSockets[s].write(data); // ./node/node_serial.js:19
        } // ./node/node_serial.js:20
 // ./node/node_serial.js:21
    } // ./node/node_serial.js:22
 // ./node/node_serial.js:23
    this.writeToDevice = function (data) { // ./node/node_serial.js:24
 // ./node/node_serial.js:25
    } // ./node/node_serial.js:26
} // ./node/node_serial.js:27
fs = require('fs') // ./node/node_main.js:0
net = require('net') // ./node/node_main.js:1
 // ./node/node_main.js:2
 // ./node/node_main.js:3
function extractArgument( arg, defaultVal  ) { // ./node/node_main.js:4
 // ./node/node_main.js:5
    for(var i = 2; i < process.argv.length ; i ++ ){ // ./node/node_main.js:6
        var argName = process.argv[i].substr(0,arg.length); // ./node/node_main.js:7
        if(argName == arg){ // ./node/node_main.js:8
            return process.argv[i].substr(arg.length+1); // ./node/node_main.js:9
        } // ./node/node_main.js:10
    } // ./node/node_main.js:11
 // ./node/node_main.js:12
    return defaultVal; // ./node/node_main.js:13
} // ./node/node_main.js:14
 // ./node/node_main.js:15
 // ./node/node_main.js:16
var dbgport = extractArgument("--dbgport","8123") // ./node/node_main.js:17
var uartPort = extractArgument("--uartport","8124") // ./node/node_main.js:18
 // ./node/node_main.js:19
if (extractArgument("--quiet","false") == "true"){ // ./node/node_main.js:20
    LOG_LEVEL = 0; // ./node/node_main.js:21
} // ./node/node_main.js:22
 // ./node/node_main.js:23
dbgport = parseInt(dbgport) // ./node/node_main.js:24
uartPort = parseInt(uartPort) // ./node/node_main.js:25
 // ./node/node_main.js:26
INFO("debug listening on port -- " + dbgport); // ./node/node_main.js:27
INFO("uart listening on port -- " + uartPort); // ./node/node_main.js:28
WARN("uart UNIMPLEMENTED"); // ./node/node_main.js:29
 // ./node/node_main.js:30
emu = 0; // ./node/node_main.js:31
 // ./node/node_main.js:32
function reset() { // ./node/node_main.js:33
    emu = new Emulator() // ./node/node_main.js:34
    emu.serialLine = new node_serial(); // ./node/node_main.js:35
    emu.tryQuit = function (exitCode) { // ./node/node_main.js:36
        process.exit(exitCode); // ./node/node_main.js:37
    } // ./node/node_main.js:38
} // ./node/node_main.js:39
 // ./node/node_main.js:40
reset(); // ./node/node_main.js:41
 // ./node/node_main.js:42
commands = new Array(); // ./node/node_main.js:43
commandLUT = {}; // ./node/node_main.js:44
 // ./node/node_main.js:45
function addCommand(name,fun){ // ./node/node_main.js:46
    commands.push(name) // ./node/node_main.js:47
    commandLUT[name] = fun; // ./node/node_main.js:48
} // ./node/node_main.js:49
 // ./node/node_main.js:50
function callNoException(newThis,func,args){ // ./node/node_main.js:51
    var oldTriggerException = emu.cpu.triggerException; // ./node/node_main.js:52
    emu.cpu.triggerException = function () {}; // ./node/node_main.js:53
    try { // ./node/node_main.js:54
        var ret = func.apply(newThis,args); // ./node/node_main.js:55
    } catch (e){ // ./node/node_main.js:56
        emu.cpu.triggerException = oldTriggerException; // ./node/node_main.js:57
        throw e; // ./node/node_main.js:58
    } // ./node/node_main.js:59
    emu.cpu.triggerException = oldTriggerException; // ./node/node_main.js:60
    return ret; // ./node/node_main.js:61
} // ./node/node_main.js:62
 // ./node/node_main.js:63
// START debugging interface // ./node/node_main.js:64
 // ./node/node_main.js:65
 // ./node/node_main.js:66
addCommand("setll", function (s,command) { // ./node/node_main.js:67
    arg = command.split(" ")[1]; // ./node/node_main.js:68
    LOG_LEVEL = parseInt(arg); // ./node/node_main.js:69
    s.write("ok\n"); // ./node/node_main.js:70
 // ./node/node_main.js:71
}); // ./node/node_main.js:72
 // ./node/node_main.js:73
 // ./node/node_main.js:74
 // ./node/node_main.js:75
 // ./node/node_main.js:76
addCommand("step", function (s,command) { // ./node/node_main.js:77
 // ./node/node_main.js:78
    emu.step(); // ./node/node_main.js:79
    s.write("ok\n"); // ./node/node_main.js:80
 // ./node/node_main.js:81
}); // ./node/node_main.js:82
 // ./node/node_main.js:83
 // ./node/node_main.js:84
isRunning = false; // ./node/node_main.js:85
runIntervalId = 0; // ./node/node_main.js:86
breakPoint = undefined; // ./node/node_main.js:87
 // ./node/node_main.js:88
function breakExecution() { // ./node/node_main.js:89
    INFO("break!"); // ./node/node_main.js:90
    if(isRunning){ // ./node/node_main.js:91
        clearInterval(runIntervalId); // ./node/node_main.js:92
    } // ./node/node_main.js:93
    isRunning = false; // ./node/node_main.js:94
 // ./node/node_main.js:95
} // ./node/node_main.js:96
 // ./node/node_main.js:97
addCommand("bp", function (s,command) { // ./node/node_main.js:98
    var addr = command.split(" ")[1]; // ./node/node_main.js:99
    addr = parseInt(addr,16); // ./node/node_main.js:100
    breakPoint = addr; // ./node/node_main.js:101
    s.write("ok bp set " + breakPoint.toString(16) + "\n"); // ./node/node_main.js:102
}); // ./node/node_main.js:103
 // ./node/node_main.js:104
addCommand("cbp", function (s,command) { // ./node/node_main.js:105
    breakPoint = undefined; // ./node/node_main.js:106
    s.write("ok\n"); // ./node/node_main.js:107
}); // ./node/node_main.js:108
 // ./node/node_main.js:109
 // ./node/node_main.js:110
addCommand("reset", function (s,command) { // ./node/node_main.js:111
    breakExecution(); // ./node/node_main.js:112
    reset() // ./node/node_main.js:113
    s.write("ok\n"); // ./node/node_main.js:114
}); // ./node/node_main.js:115
 // ./node/node_main.js:116
 // ./node/node_main.js:117
addCommand("isrunning", function (s,command) { // ./node/node_main.js:118
    if(isRunning) { // ./node/node_main.js:119
        s.write("ok 1\n"); // ./node/node_main.js:120
    } else { // ./node/node_main.js:121
        s.write("ok 0\n"); // ./node/node_main.js:122
    } // ./node/node_main.js:123
 // ./node/node_main.js:124
}); // ./node/node_main.js:125
 // ./node/node_main.js:126
 // ./node/node_main.js:127
addCommand("run", function (s,command) { // ./node/node_main.js:128
    isRunning = true; // ./node/node_main.js:129
    runIntervalId = setInterval( function () { // ./node/node_main.js:130
        for ( var i = 0 ; i < 10000 ; i++ ) { // ./node/node_main.js:131
            if( emu.cpu.PC.asUInt32() == breakPoint ){ // ./node/node_main.js:132
                breakExecution(); // ./node/node_main.js:133
            } // ./node/node_main.js:134
            if(isRunning){ // ./node/node_main.js:135
                emu.step(); // ./node/node_main.js:136
            } else { // ./node/node_main.js:137
                break; // ./node/node_main.js:138
            } // ./node/node_main.js:139
        } // ./node/node_main.js:140
    } , 1); // ./node/node_main.js:141
 // ./node/node_main.js:142
    s.write("ok\n"); // ./node/node_main.js:143
 // ./node/node_main.js:144
}); // ./node/node_main.js:145
 // ./node/node_main.js:146
addCommand("break", function (s,command) { // ./node/node_main.js:147
    breakExecution(); // ./node/node_main.js:148
    s.write("ok\n"); // ./node/node_main.js:149
 // ./node/node_main.js:150
}); // ./node/node_main.js:151
 // ./node/node_main.js:152
addCommand("readtlb", function (s,command) { // ./node/node_main.js:153
	var tlb = emu.mmu.tlb; // ./node/node_main.js:154
	s.write("TLB entries: \n"); // ./node/node_main.js:155
 // ./node/node_main.js:156
	for(var i = 0; i < 64; i += 4) // ./node/node_main.js:157
	{ // ./node/node_main.js:158
		s.write("#" + (i/4).toString() + "\n"); // ./node/node_main.js:159
		var tlbEntry0 = tlb[i]; // ./node/node_main.js:160
		var tlbEntry1 = tlb[i+1]; // ./node/node_main.js:161
		var pagemask = tlbEntry0; // ./node/node_main.js:162
		var VPN2 = (tlbEntry1 >>> 9); // ./node/node_main.js:163
		var G = (tlbEntry1 >>> 8) & 0x1; // ./node/node_main.js:164
		var ASID = (tlbEntry1 & 0xff); // ./node/node_main.js:165
 // ./node/node_main.js:166
 // ./node/node_main.js:167
		s.write("PageMask[24:13] = " + pagemask.toString(16) + "\n"); // ./node/node_main.js:168
		s.write("VPN2[31:13] = " + VPN2.toString(16) + "\n"); // ./node/node_main.js:169
		s.write("G = " + G.toString(16) + "\n"); // ./node/node_main.js:170
		s.write("ASID[7:0] = " + ASID.toString(16) + "\n"); // ./node/node_main.js:171
 // ./node/node_main.js:172
		var tlbEntry2 = tlb[i+2]; // ./node/node_main.js:173
		var tlbEntry3 = tlb[i+3]; // ./node/node_main.js:174
		var PFN0 = (tlbEntry2 >>> 5); // ./node/node_main.js:175
		var C0 = (tlbEntry2 >>> 2) & 0x7; // ./node/node_main.js:176
		var D0 = (tlbEntry2 >>> 1) & 0x1; // ./node/node_main.js:177
		var V0 = (tlbEntry2 & 0x1) >>> 0; // ./node/node_main.js:178
 // ./node/node_main.js:179
		var PFN1 = (tlbEntry3 >>> 5); // ./node/node_main.js:180
		var C1 = (tlbEntry3 >>> 2) & 0x7; // ./node/node_main.js:181
		var D1 = (tlbEntry3 >>> 1) & 0x1; // ./node/node_main.js:182
		var V1 = (tlbEntry3 & 0x1) >>> 0; // ./node/node_main.js:183
 // ./node/node_main.js:184
		s.write("Entry #1: \n"); // ./node/node_main.js:185
		s.write("PFN0: " + PFN0.toString(16) + ", C0: " + C0.toString(16) + ", D0: " + D0.toString() + ", V0: " + V0.toString() + "\n"); // ./node/node_main.js:186
		s.write("Entry #2: \n"); // ./node/node_main.js:187
		s.write("PFN1: " + PFN1.toString(16) + ", C1: " + C1.toString(16) + ", D1: " + D1.toString() + ", V1: " + V1.toString() + "\n"); // ./node/node_main.js:188
		s.write("\n"); // ./node/node_main.js:189
 // ./node/node_main.js:190
